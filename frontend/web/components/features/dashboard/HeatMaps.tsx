...
const HeatMaps = () => {
  const [activeTab, setActiveTab] = useState<'shots' | 'player'>('shots');
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2 mb-4">
          <button
            ...
            aria-label="View shots heat map"
          >
            Shots
          </button>
          <button
            ...
            aria-label="View player heat map"
          >
            Player
          </button>
        </div>
      ...
      <div className="p-4 flex justify-center">
        <div className="relative w-full">
          <Image
            ...
            alt={activeTab === 'shots' ? 'Tennis court with shot markers' : 'Tennis court player movement heat map'}
            width={800}
            height={500}
          ...
          {activeTab === 'shots' && (
            <>
              ...
              <div className="absolute top-[30%] left-[20%] w-3 h-3 bg-yellow-400 rounded-full transform -translate-x-1/2 -translate-y-1/2" aria-hidden="true"></div>
              <div className="absolute top-[45%] left-[35%] w-3 h-3 bg-yellow-400 rounded-full transform -translate-x-1/2 -translate-y-1/2" aria-hidden="true"></div>
              <div className="absolute top-[60%] left-[70%] w-3 h-3 bg-yellow-400 rounded-full transform -translate-x-1/2 -translate-y-1/2" aria-hidden="true"></div>
              <div className="absolute top-[25%] left-[80%] w-3 h-3 bg-yellow-400 rounded-full transform -translate-x-1/2 -translate-y-1/2" aria-hidden="true"></div>
              <div className="absolute top-[70%] left-[25%] w-3 h-3 bg-yellow-400 rounded-full transform -translate-x-1/2 -translate-y-1/2" aria-hidden="true"></div>
            </>
          )}
        </div>
      </div>
      ...
      <div className="p-4 flex justify-center">
        <div className="relative w-full">
          <Image
            ...
            alt="Tennis court heat map visualization"
            width={800}
            height={500}
            className="w-full rounded-lg"
          />
