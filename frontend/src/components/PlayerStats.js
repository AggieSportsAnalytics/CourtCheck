...
const PlayerStats = () => {
  ...
  return (
    <div className="bg-secondary rounded-xl p-4">
      <h3 className="text-xl font-bold mb-4">Player-Movement</h3>
      
      {/* Player Selection */}
      <div className="grid grid-cols-2 gap-2 mb-4">
        <button
          className={`py-2 rounded-md ${activePlayer === 'player1' ? 'bg-gray-600' : 'bg-gray-800'}`}
          onClick={() => setActivePlayer('player1')}
        >
          Cory_Pham_22
        </button>
        <button
          className={`py-2 rounded-md ${activePlayer === 'player2' ? 'bg-gray-600' : 'bg-gray-800'}`}
      ...
      <div className="mt-4">
        <div className="relative">
          ...
          <div className="h-56 bg-gray-800 rounded-lg flex items-end px-2">
