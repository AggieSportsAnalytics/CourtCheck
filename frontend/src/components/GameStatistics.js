...
const GameStatistics = () => {
  ...
  return (
    <div className="bg-secondary rounded-xl p-4">
      <h3 className="text-xl font-bold mb-4">Points-by-Shots</h3>
      
      <div className="flex flex-col">
        {/* Error count */}
        <div className="mb-6">
          <span className="text-sm text-gray-400">Total number of errors:</span>
          <span className="ml-2 text-xl font-bold">306</span>
        </div>
          ...
          <div className="w-full lg:w-3/4 h-44 flex items-end justify-around space-x-6 mb-6">
            {shotTypes.map((shot, index) => (
              <div key={index} className="flex flex-col items-center">
                ...
                <div className={`w-6 h-6 rounded-full ${shot.color} -mt-3 flex items-center justify-center text-xs font-bold`}>
