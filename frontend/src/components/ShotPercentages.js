...
const ShotPercentages = () => {
  ...
  return (
    <div className="bg-secondary rounded-xl p-4">
      <h3 className="text-xl font-bold mb-4">Shot Percentages</h3>
      ...
      <div className="flex items-center justify-center mt-4">
        <div className="w-36 h-36 rounded-full border-4 border-gray-700 relative" ref={chartRef}>
          ...
          {/* Center circle */}
          <div className="absolute w-16 h-16 bg-secondary rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
