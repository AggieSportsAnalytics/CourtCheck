            ...
            {selectedMatch && (
              <div className="mt-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-4">
                        <div>
                          <div className="flex justify-between items-center mb-1">
                            <span className="text-gray-400">Bounce Detection</span>
                            <span className="text-green-400 font-medium">{selectedMatch.stats.bounceAccuracy}% accuracy</span>
                          </div>
                          <div className="w-full bg-gray-700 rounded-full h-2">
                            <div 
                              className="bg-green-500 h-2 rounded-full" 
                              style={{ width: `${selectedMatch.stats.bounceAccuracy}%` }}
                            ></div>
                          </div>
                        </div>
                        ...
                        <div>
                          <div className="flex justify-between items-center mb-1">
                            <span className="text-gray-400">Court Alignment</span>
                            <span className="text-blue-400 font-medium">{selectedMatch.analysis.courtAlignment.accuracy}% accuracy</span>
                          </div>
                          <div className="w-full bg-gray-700 rounded-full h-2">
                            <div 
                              className="bg-blue-500 h-2 rounded-full" 
                              style={{ width: `${selectedMatch.analysis.courtAlignment.accuracy}%` }}
                            ></div>
                          </div>
                        </div>
                  ...
                  {/* Right Columns: Heatmaps and Videos */}
                  <div className="lg:col-span-2 space-y-6">
                    {/* Bounce Heatmap */}
                    <div className="bg-gray-800 rounded-xl p-5 shadow-md">
                      <h3 className="text-white font-bold mb-4">Bounce Heatmap</h3>
                      <div className="relative aspect-video bg-gray-900 rounded-lg overflow-hidden">
                        <img 
                          src={selectedMatch.analysis.heatmaps.bounces} 
                          alt="Bounce Heatmap" 
                          className="w-full h-full object-contain"
                        />
                      </div>
                      <div className="mt-3 text-gray-400 text-sm">
                        Visual representation of where balls are bouncing most frequently during the match.
                      </div>
                    </div>
                    
                    {/* Video Analysis */}
                    <div className="bg-gray-800 rounded-xl p-5 shadow-md">
                      <h3 className="text-white font-bold mb-4">Video Analysis</h3>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <div className="relative aspect-video bg-gray-900 rounded-lg overflow-hidden flex items-center justify-center">
                            <HiVideoCamera className="w-16 h-16 text-gray-700" />
                            <div className="absolute inset-0 flex items-center justify-center">
                              <button className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg shadow-lg flex items-center">
                                <HiChartBar className="mr-2" /> 
                                View Overlay
                              </button>
                            </div>
                          </div>
                          <div className="mt-2 text-sm text-gray-400">Court detection & ball tracking overlay</div>
                        </div>
                        <div>
                          <div className="relative aspect-video bg-gray-900 rounded-lg overflow-hidden flex items-center justify-center">
                            <HiVideoCamera className="w-16 h-16 text-gray-700" />
                          ...
                          <div className="mt-2 text-sm text-gray-400">Real-time minimap of court positions</div>
                        </div>
                      </div>
                    </div>
