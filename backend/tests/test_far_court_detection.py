...
def _make_court_bounds():
    ...
    return {
        ...
        'left_x':   ref.left_court_line[0][0],
        'right_x':  ref.right_court_line[0][0],
        'far_y_min': ref.baseline_top[0][1] - 100,
        'far_y_max': ref.net[0][1] + 30,
    }
...
class TestFarPlayerCourtSpaceFilter:
    def test_far_player_accepted_when_in_far_court(self):
        ...
        from backend.models.player_tracker import _far_player_score
        ...
        score = _far_player_score(far_bbox, near_id=near_id, tid=1, H_ref=H_ref,
                                  court_bounds=_make_court_bounds(), x_margin=500)
        assert score > 0, (
    ...
    def test_spectator_rejected_when_outside_court(self):
        ...
        score = _far_player_score(spectator_bbox, near_id=near_id, tid=2, H_ref=H_ref,
                                  court_bounds=_make_court_bounds(), x_margin=500)
        assert score == 0.0, (
    ...
    def test_near_player_id_always_excluded(self):
        ...
        score = _far_player_score(far_bbox, near_id=1, tid=1, H_ref=H_ref,
                                  court_bounds=_make_court_bounds(), x_margin=500)
        assert score == 0.0
